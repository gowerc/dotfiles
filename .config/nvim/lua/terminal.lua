...
-- Track number of terminals that have been opened so that we can give
-- them uniqu enames
TERMINAL_INDEX_PYTHON = 1
TERMINAL_INDEX_R = 1
TERMINAL_INDEX_BASH = 1

-- need to use vim.api.nvim_input instead of vim.cmd as vim.api.nvim_input
...
vim.keymap.set("i", "<A-h>", "<C-\\><C-N><C-w>ha")
vim.keymap.set("i", "<A-j>", "<C-\\><C-N><C-w>ja")
vim.keymap.set("i", "<A-k>", "<C-\\><C-N><C-w>ka")
vim.keymap.set("i", "<A-l>", "<C-\\><C-N><C-w>la")
vim.keymap.set("n", "<A-h>", "<C-w>ha")
vim.keymap.set("n", "<A-j>", "<C-w>ja")
vim.keymap.set("n", "<A-k>", "<C-w>ka")
vim.keymap.set("n", "<A-l>", "<C-w>la")
